...
#define BLT_INT_GPIO_PORT    	  GPIOE		                       /* GPIO端口 */
#define BLT_INT_GPIO_CLK() 	   __HAL_RCC_GPIOE_CLK_ENABLE()		   /* GPIO端口时钟 */
#define BLT_INT_GPIO_PIN		  	GPIO_PIN_2			                 /* 连接到HC05 INT引脚的GPIO */

#define BLT_KEY_GPIO_PORT    	  GPIOA			                        /* GPIO端口 */
#define BLT_KEY_GPIO_CLK()	      __HAL_RCC_GPIOB_CLK_ENABLE()			/* GPIO端口时钟 */
#define BLT_KEY_GPIO_PIN		    GPIO_PIN_12		                   /* 连接到HC05 KEY引脚的GPIO */
