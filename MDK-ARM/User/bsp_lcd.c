...
/*根据液晶数据手册的参数配置*/
#define HBP  0    //HSYNC后的无效像素
#define VBP  45   //VSYNC后的无效行数

#define HSW  128  //HSYNC宽度
#define VSW  128  //VSYNC宽度

#define HFP  88   //HSYNC前的无效像素
#define VFP  13   //VSYNC前的无效行数
...
{ 
	...
	if(offset == -1)
		printf("no found fouts in FLASH\r\n");
	else
